...
## 🕹️ About the Project
For "Week 0", I developed a simple yet fun interactive game using *Scratch*. Although it's a basic project, it was a great way to dive into:
* *Logic & Problem Solving*: Thinking like a programmer.
* *Control Flow*: Using loops and conditional statements.
* *Creativity*: Designing sprites and interactive elements.
